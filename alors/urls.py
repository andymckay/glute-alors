...
urlpatterns = [
    ...
    path(
        "planned/<int:pk>/move/",
        views.move_planned_workout,
        name="move_planned_workout",
    ),
    path(
        "planned/webcal.ics",
    ...
    path("saved-workouts/", views.saved_workout_list, name="saved_workout_list"),
    path("saved-workouts/add/", views.saved_workout_add, name="saved_workout_add"),
    path(
        "saved-workouts/<int:pk>/edit/",
        views.saved_workout_edit,
        name="saved_workout_edit",
    ),
    path(
        "saved-workouts/<int:pk>/delete/",
        views.saved_workout_delete,
        name="saved_workout_delete",
    ),
